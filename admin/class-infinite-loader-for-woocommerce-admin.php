...
class Infinite_Loader_For_Woocommerce_Admin {
	...
	public function infinite_loader_for_woocommerce_previous_button_style() {
		...
		$infinite_loader_load_previous_button_style .= 'border-top-color: ' . $infinite_loader_prev_button_border_top . 'px solid ' . $b1 . ';';
		$infinite_loader_load_previous_button_style .= 'border-right-color: ' . $infinite_loader_prev_button_border_bottom . 'px solid ' . $b1 . ';';
		$infinite_loader_load_previous_button_style .= 'border-bottom-color: ' . $infinite_loader_prev_button_border_left . 'px solid ' . $b1 . ';';
		$infinite_loader_load_previous_button_style .= 'border-left-color: ' . $infinite_loader_prev_button_border_right . 'px solid ' . $b1 . ';';
