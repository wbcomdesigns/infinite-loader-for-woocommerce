...
<span class="il-box-field"><label for="infinite-loader_set-default-border-top"><?php esc_html_e( 'Top', 'infinite-loader-for-woocommerce' ); ?></label><input type="number" class="infinite-loader-style infinite_loader_btn_settings" data-style="border-top" data-type="px" data-default="1" data-field="border" id="infinite-loader_set-default-border-top"  name="infinite_loader_admin_previous_button_option[border_top]" value="<?php echo ( isset( $infinite_loader_previous_button_setting['border_top'] ) ) ? esc_attr( $infinite_loader_previous_button_setting['border_top'] ) : '1'; ?>"></span>
					...
					<div class="wbcom-settings-section-wrap">
						<div class="wbcom-settings-section-options-heading">
							...
							<?php
							esc_html_e(
								'Adjust the corner roundness of the button (in pixels).
',
