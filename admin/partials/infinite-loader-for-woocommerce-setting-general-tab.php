					...
					<td>
						<label class="infinity-loader-switch">
							<select id="infinity-loader-loading-type" name="infinite_loader_admin_general_option[product_loading_type]">
								...
								<option value="ajax-pagination" <?php selected( $infinite_loader_genral_setting['product_loading_type'], 'ajax-pagination' ); ?>><?php esc_html_e( 'AJAX Pagination', 'infinite-loader-for-woocommerce' ); ?></option>
