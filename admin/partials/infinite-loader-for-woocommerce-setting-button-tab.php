...
<form method="post" action="options.php">
	...
	Wbcom_Settings_Page::card_open( __( 'Button Style Settings', 'infinite-loader-for-woocommerce' ) );
	?>
	<div class="wbcom-field">
		<label for="infinite_loader_default_custom_class"><?php esc_html_e( 'Custom CSS Class', 'infinite-loader-for-woocommerce' ); ?></label>
		...
		<input type="text" class="wbcom-input infinite_loader_btn_settings" data-style="custom_css" id="infinite_loader_default_custom_class" name="infinite_loader_admin_button_option[custom_class]" value="<?php echo ( isset( $infinite_loader_button_setting['custom_class'] ) ) ? esc_attr( $infinite_loader_button_setting['custom_class'] ) : ''; ?>">
	</div>
	...
	<div class="wbcom-field">
		<label for="infinite_loader_default_load_more_botton_text"><?php esc_html_e( 'Load More Button Text', 'infinite-loader-for-woocommerce' ); ?></label>
		...
		<input type="text" class="wbcom-input infinite_loader_btn_settings" data-default="Load More" data-style="text" id="infinite_loader_default_load_more_botton_text" name="infinite_loader_admin_button_option[button_text]" placeholder="<?php esc_attr_e( 'Load More', 'infinite-loader-for-woocommerce' ); ?>" value="<?php echo ( isset( $infinite_loader_button_setting['button_text'] ) ) ? esc_attr( $infinite_loader_button_setting['button_text'] ) : 'Load More'; ?>">
	</div>

	<div class="wbcom-field wbcom-field-group">
		<div class="wbcom-field-info">
			<label for="infinite_loader_default_bg_color"><?php esc_html_e( 'Button Background Color', 'infinite-loader-for-woocommerce' ); ?></label>
	...
	<div class="wbcom-field wbcom-field-group">
		<div class="wbcom-field-info">
			<label for="infinite_loader_default_bg_color_mouse_hover"><?php esc_html_e( 'Button Hover Background Color', 'infinite-loader-for-woocommerce' ); ?></label>
	...
	<div class="wbcom-field wbcom-field-group">
		<div class="wbcom-field-info">
			<label for="infinite_loader_default_border_color"><?php esc_html_e( 'Button Border Color', 'infinite-loader-for-woocommerce' ); ?></label>
	...
	<div class="wbcom-field wbcom-field-group">
		<div class="wbcom-field-info">
			<label for="infinite_loader_default_text_color"><?php esc_html_e( 'Button Text Color', 'infinite-loader-for-woocommerce' ); ?></label>
			<p class="description"><?php esc_html_e( 'Choose the text color for the Load More button.', 'infinite-loader-for-woocommerce' ); ?></p>
		</div>
		<div class="wbcom-field-control">
			<input type="color" id="infinite_loader_default_text_color" class="txt_btn_color" data-default="#ffffff" name="infinite_loader_admin_button_option[text_color]" value="<?php echo ( isset( $infinite_loader_button_setting['text_color'] ) ) ? esc_attr( $infinite_loader_button_setting['text_color'] ) : '#fff'; ?>">
			<input type="button" value="<?php esc_attr_e( 'Default', 'infinite-loader-for-woocommerce' ); ?>" class="button infinite-loader-color-reset">
		</div>
	</div>
	...
	<div class="wbcom-field wbcom-field-group">
		<div class="wbcom-field-info">
			<label for="infinite_loader_default_text_color_mouse_hover"><?php esc_html_e( 'Button Hover Text Color', 'infinite-loader-for-woocommerce' ); ?></label>
