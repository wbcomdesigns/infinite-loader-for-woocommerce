				...
				<div class="form-table">
					<div class="wbcom-settings-section-wrap">
						<div class="wbcom-settings-section-options-heading">
							...
							<p><?php esc_html_e( 'Specify a custom CSS class to style the Load More button.', 'infinite-loader-for-woocommerce' ) ?></p>
						</div>
					...
					<div class="wbcom-settings-section-wrap">
						<div class="wbcom-settings-section-options-heading">
							...
							<p><?php esc_html_e( 'Preview the appearance of the Load More button below.', 'infinite-loader-for-woocommerce' ) ?></p>
						</div>
						<div class="wbcom-settings-section-options">
					...
					<div class="wbcom-settings-section-wrap">
						<div class="wbcom-settings-section-options-heading">
							...
							<p><?php esc_html_e( 'Enter the text to display on the Load More button.', 'infinite-loader-for-woocommerce' ) ?></p>
						</div>
						<div class="wbcom-settings-section-options">
					...
					<div class="wbcom-settings-section-wrap">
						<div class="wbcom-settings-section-options-heading">
							...
							<p><?php esc_html_e( 'Choose a background color for the Load More button.', 'infinite-loader-for-woocommerce' ) ?></p>
						</div>
						<div class="wbcom-settings-section-options">
