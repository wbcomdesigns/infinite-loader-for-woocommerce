	...
	public static function render_welcome() {
		...
		<div class="wrap wbcom-admin">
			<header class="wbcom-page-header">
				...
				<div>
					<h1><?php esc_html_e( 'WB Plugins', 'infinite-loader-for-woocommerce' ); ?></h1>
					<p class="wbcom-page-header__subtitle">
						<?php
						echo esc_html(
							sprintf(
								/* translators: %d: number of active Wbcom plugins. */
								_n( '%d Wbcom plugin active on this site.', '%d Wbcom plugins active on this site.', $count, 'infinite-loader-for-woocommerce' ),
								$count
							)
						);
						?>
			...
			<?php if ( 0 === $count ) : ?>
				<div class="wbcom-empty-state">
					...
					<p class="wbcom-empty-state__title"><?php esc_html_e( 'No Wbcom plugins attached to this hub yet', 'infinite-loader-for-woocommerce' ); ?></p>
					<p class="wbcom-empty-state__desc"><?php esc_html_e( 'Activate one and it will appear here automatically.', 'infinite-loader-for-woocommerce' ); ?></p>
				</div>
			<?php else : ?>
					...
					<?php foreach ( $plugins as $plugin ) : ?>
						<a class="wbcom-hub-card" href="<?php echo esc_url( $plugin['url'] ); ?>">
							...
							<span class="wbcom-hub-card__cta">
								<?php esc_html_e( 'Open settings', 'infinite-loader-for-woocommerce' ); ?>
			...
			<?php
			self::card_open( __( 'About WB Plugins', 'infinite-loader-for-woocommerce' ) );
			?>
			<p>
				<?php esc_html_e( 'This hub is the single entry point for every Wbcom Designs plugin installed on your site. Each plugin lives on its own page under this menu and keeps its own settings, licence, and data.', 'infinite-loader-for-woocommerce' ); ?>
			</p>
			<p>
				<a href="https://wbcomdesigns.com/" target="_blank" rel="noopener noreferrer">
					<?php esc_html_e( 'Visit wbcomdesigns.com for more plugins and themes', 'infinite-loader-for-woocommerce' ); ?>
					<i data-lucide="arrow-right"></i>
				</a>
			</p>
			<?php
