...
class Infinite_Loader_For_Woocommerce_Public {
	...
	public function infinite_loader_products_count_additional( $text ) {
		...
		$total    = $infinite_loader_count_data['total'];
		$per_page = $infinite_loader_count_data['per_page'];
		$first    = $infinite_loader_count_data['first'];
		$last     = $infinite_loader_count_data['last'];
